...
public class Example
{
    ...
    {
        int[,] array2D = new int[,] { 
            { 0x00000, 0x0008F, 1}, {0x00090, 0x000CF, 2}, {0x000D0, 0x0209F, 0}, {0x020A0, 0x020FF, 2}, {0x02100, 0x34EFF, 0},{ 0x34F00, 0x3541F, 2},{ 0x35420, 0x4191F, 1},
            { 0x41920, 0x44CDF, 2},{ 0x44CE0, 0x450DF, 1}, {0x450E0, 0x4519F, 2}, {0x451A0, 0x451BF, 0}, {0x451C0, 0x4529F, 2}, {0x452A0, 0x452BF, 0}, {0x452C0, 0x4539F, 2},
            { 0x453A0, 0x453BF, 0}, {0x453C0, 0x4549F, 2}, {0x454A0, 0x454BF, 0}, {0x454C0, 0x4559F, 2}, {0x455A0, 0x455BF, 0}, {0x455C0, 0x4569F, 2}, {0x456A0, 0x456BF, 0},
            { 0x456C0, 0x4579F, 2}, {0x457A0, 0x457BF, 0}, {0x457C0, 0x4589F, 2}, {0x458A0, 0x459BF, 0}, {0x459C0, 0x45A9F, 2}, {0x45AA0, 0x45ABF, 0}, {0x45AC0, 0x45B9F, 2},
        ...
        byte[] bytesOrig = System.IO.File.ReadAllBytes("L:/save_2_wiiu.bin");
        // Offset after which endian is swapped?
        //int pos = 0x535BF;
        FileStream file = File.Create("L:/save_2_wiiu_converted.bin");
